...
namespace FicticiousBooksellers.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ISBN13,ISBN10,Title,Author,Description,PublicationDate,Image,Price,Stock,Category")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ISBN13,ISBN10,Title,Author,Description,PublicationDate,Image,Price,Stock,Category")] Book book)
        {
            if (ModelState.IsValid)
            {
